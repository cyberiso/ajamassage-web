    ...
    >
      ...
      <Grid container spacing={isMobile ? 2 : 4}> {/* Mobilde spacing 2 */}
        ...
        <Grid item xs={12} md={6}>
          <Paper elevation={3} sx={{ p: isMobile ? 2 : 3 }}> {/* Mobilde 16px padding */}
            ...
            <form onSubmit={handleSubmit}>
              ...
              <TextField
                ...
                margin="normal"
                multiline
                rows={isMobile ? 2 : 3} // Mobilde 2 satır
                required
                size={isMobile ? 'small' : 'medium'}
              />
              <Button
        ...
        <Grid item xs={12} md={6}>
          <Paper elevation={3} sx={{ p: isMobile ? 2 : 3 }}> {/* Mobilde 16px padding */}
            ...
            <Typography variant={isMobile ? 'body2' : 'body1'}>
              <strong>{t('email')}:</strong> {t('sample_email')}
            </Typography>
        ...
        <Grid item xs={12}>
          <Paper
            elevation={3}
            sx={{ p: isMobile ? 2 : 3, mt: isMobile ? 2 : 5, textAlign: 'center' }} // Mobilde mt 2
          >
            <Typography variant={isMobile ? 'h6' : 'h5'} gutterBottom>
              {t('find_us_on_map')}
            </Typography>
            <iframe
src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3541.643533031812!2d6.928805756328241!3d51.1210023073461!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47bf339c6fc4d6c7%3A0x96f1829603f75075!2sAJA%20Massage-%20und%20Wellnesszentrum%20GmbH!5e0!3m2!1str!2str!4v1742844306369!5m2!1str!2str"              width="100%"
